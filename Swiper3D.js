 ...
 * 3D Swiper
 */
export default class Swiper3D extends Component {
	...
	responder = PanResponder.create({
		...
		onPanResponderMove: (evt, gestureState) => {
	        ...
	        let v = gestureState.dx / -this.state.width;
	        this.position.setValue(v);
		},
		// 下面这两段代码等效
	...
	render() {
		...
		const r = Math.sqrt(3) / space * this.state.width;
		return (
			<View
